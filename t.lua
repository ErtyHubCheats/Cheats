...
function Library:new(option)
	local move_men_ = false
	local player = game.Players.LocalPlayer
	local mouse = player:GetMouse()
	local mouseX,mouseY,htbX
	local mouseX2,mouseY2,move_men_ic
	...
	Library.Tree["8"]["FontFace"] = Font.new([[rbxasset://fonts/families/Merriweather.json]], Enum.FontWeight.Bold, Enum.FontStyle.Normal);
	Library.Tree["8"]["TextColor3"] = Color3.fromRGB(0, 0, 0);
	Library.Tree["8"]["BackgroundTransparency"] = 1;
	Library.Tree["8"]["Size"] = UDim2.new(0.550352812, 0, 1, 0)
	Library.Tree["8"]["TextScaled"] = true
	Library.Tree["8"]["Position"] = UDim2.new(0.0606799424, 0, -0.0231512878, 0)
	Library.Tree["8"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
	Library.Tree["8"]["Text"] = "Milkashka:D [" .. option.Name .. "]["..option.Version.."] DEV";
	Library.Tree["8"]["Name"] = [[Title]];
	
	Library.Tree["tgg8"] = Instance.new("UITextSizeConstraint")
	Library.Tree["tgg8"].Parent = Library.Tree["8"]
	Library.Tree["tgg8"].MinTextSize = 1
	Library.Tree["tgg8"].MaxTextSize = 80
	
	Library.Tree["hh8"] = Instance.new("ImageLabel")
	Library.Tree["hh8"].Parent = Library.Tree["7"]
	Library.Tree["hh8"].AnchorPoint = Vector2.new(1, 0)
	Library.Tree["hh8"].BackgroundColor3 = Color3.fromRGB(49, 49, 49)
	Library.Tree["hh8"].BackgroundTransparency = 0.050
	Library.Tree["hh8"].BorderColor3 = Color3.fromRGB(0, 0, 0)
	Library.Tree["hh8"].BorderSizePixel = 0
	Library.Tree["hh8"].Position = UDim2.new(0.050999999, 0, 0.0926051512, 0)
	Library.Tree["hh8"].Size = UDim2.new(0.0448627435, 0, 0.907394767, 0)
	Library.Tree["hh8"].Image = "rbxassetid://130160595723352"
	Library.Tree["hty8"] = Instance.new("UIAspectRatioConstraint")
	Library.Tree["hty8"].Parent = Library.Tree["hh8"]
	Library.Tree["hty8"].AspectRatio = 1.008
	...
	Library.Tree["hty9"] = Instance.new("ImageButton", Library.Tree["7"])
	Library.Tree["hty9"].AnchorPoint = Vector2.new(1, 0)
	Library.Tree["hty9"].BackgroundColor3 = Color3.fromRGB(49, 49, 49)
	Library.Tree["hty9"].BackgroundTransparency = 0.050
	Library.Tree["hty9"].BorderColor3 = Color3.fromRGB(0, 0, 0)
	Library.Tree["hty9"].BorderSizePixel = 0
	Library.Tree["hty9"].Position = UDim2.new(0.951, 0, 0, 0)
	Library.Tree["hty9"].Size = UDim2.new(0.049, 0, 1, 0)
	Library.Tree["hty9"].Image = "http://www.roblox.com/asset/?id=6031094678"
	Library.Tree["hty9"].MouseButton1Click:Connect(function()
		Library.DeleteMenu()
	end)
	Library.Tree["hh9"] = Instance.new("UIAspectRatioConstraint")
	Library.Tree["hh9"].Parent = Library.Tree["hty9"]
	Library.Tree["hh9"].AspectRatio = 1.008
	...
	Library.Tree["7"].InputBegan:Connect(function(tt,pp)
		if tt.UserInputType == Enum.UserInputType.MouseButton1 or tt.UserInputType == Enum.UserInputType.Touch then
			mouseX = mouse.X - Library.Tree["7"].AbsolutePosition.X
			mouseY = mouse.Y - Library.Tree["7"].AbsolutePosition.Y
			htbX = Library.Tree["2"].AbsolutePosition.X-Library.Tree["21"].AbsolutePosition.X
			move_men_ = true
		end
	end)
	Library.Tree["7"].InputEnded:Connect(function(tt,pp)
		if tt.UserInputType == Enum.UserInputType.MouseButton1 or tt.UserInputType == Enum.UserInputType.Touch then
			move_men_ = false
		end
	end)
	coroutine.wrap(function()
		game:GetService("RunService").RenderStepped:Connect(function()
			if move_men_ then
				Library.Tree["2"].Position =  UDim2.new(0, mouse.X - mouseX, 0, mouse.Y - mouseY)
				Library.Tree["21"].Position =  UDim2.new(0, mouse.X - mouseX-htbX, 0, mouse.Y - mouseY)
			end
		end)
	end)()
	...
	Library.Tree["37"].InputBegan:Connect(function(tt,pp)
		if tt.UserInputType == Enum.UserInputType.MouseButton1 or tt.UserInputType == Enum.UserInputType.Touch then
			mouseX2 = mouse.X - Library.Tree["37"].AbsolutePosition.X
			mouseY2 = mouse.Y - Library.Tree["37"].AbsolutePosition.Y
			move_men_ic = true
		end
	end)
	Library.Tree["37"].InputEnded:Connect(function(tt,pp)
		if tt.UserInputType == Enum.UserInputType.MouseButton1 or tt.UserInputType == Enum.UserInputType.Touch then
			move_men_ic = false
		end
	end)
	coroutine.wrap(function()
		game:GetService("RunService").RenderStepped:Connect(function()
			if move_men_ic then
				Library.Tree["37"].Position =  UDim2.new(0, mouse.X - mouseX2, 0, mouse.Y - mouseY2)
			end
		end)
	end)()
	...
	function Library:CreateTabs(tabs)
		for nn,v in pairs(tabs) do
			Tabs_c["T"..v.Name] = Instance.new("TextButton", Library.Tree["26"]);
			Tabs_c["T"..v.Name]["Name"] = v.Name;
			Tabs_c["T"..v.Name]["TextWrapped"] = true;
			Tabs_c["T"..v.Name]["BorderSizePixel"] = 0;
			Tabs_c["T"..v.Name]["TextSize"] = 30;
			Tabs_c["T"..v.Name]["TextColor3"] = Color3.fromRGB(255, 255, 255);
			Tabs_c["T"..v.Name]["TextScaled"] = true;
			Tabs_c["T"..v.Name]["BackgroundColor3"] = Color3.fromRGB(58, 58, 58);
			Tabs_c["T"..v.Name]["FontFace"] = Font.new([[rbxasset://fonts/families/SourceSansPro.json]], Enum.FontWeight.Bold, Enum.FontStyle.Normal);
			Tabs_c["T"..v.Name]["Size"] = UDim2.new(0.9, 0, 0.09, 0);
			Tabs_c["T"..v.Name]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
			Tabs_c["T"..v.Name]["Text"] = v.Name;
			Tabs_c["T"..v.Name]["Position"] = UDim2.new(0.1, 0, 0.02893, 0);

			-- StarterGui.MyLibrary.Navigation.ScrollingFrame.TextButton.UICorner
			Library.Tree["29"] = Instance.new("UICorner", Tabs_c["T"..v.Name]);
			Library.Tree["29"]["CornerRadius"] = UDim.new(0, 15);

			-- StarterGui.MyLibrary.Navigation.ScrollingFrame.TextButton.UIStroke
			Library.Tree["2a"] = Instance.new("UIStroke", Tabs_c["T"..v.Name]);
			...
			Library.Tree["2b"] = Instance.new("UITextSizeConstraint", Tabs_c["T"..v.Name]);
			Library.Tree["2b"]["MaxTextSize"] = 30;

			Tabs_b["T"..v.Name] = Instance.new("ScrollingFrame", Library.Tree["b"]);
			Tabs_b["T"..v.Name]["Active"] = true;
			Tabs_b["T"..v.Name]["BorderSizePixel"] = 0;
			Tabs_b["T"..v.Name]["CanvasSize"] = UDim2.new(0, 0, 0, 4);
			Tabs_b["T"..v.Name]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
			Tabs_b["T"..v.Name]["Name"] = "T"..v.Name;
			Tabs_b["T"..v.Name]["Size"] = UDim2.new(1, 0, 1, 0);
			Tabs_b["T"..v.Name]["ScrollBarImageColor3"] = Color3.fromRGB(107, 107, 107);
			Tabs_b["T"..v.Name]["Position"] = UDim2.new(0, 0, 0, 0);
			Tabs_b["T"..v.Name]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
			Tabs_b["T"..v.Name]["BackgroundTransparency"] = 1;
			Library.Tree["d2"] = Instance.new("UIListLayout", Tabs_b["T"..v.Name]);
			...
			Library.Tree["d3"] = Instance.new("UIPadding", Tabs_b["T"..v.Name]);
			Library.Tree["d3"]["PaddingTop"] = UDim.new(0, 4);
			Library.Tree["d3"]["PaddingLeft"] = UDim.new(0, 10);
			if nn > 1 then
				Tabs_b["T"..v.Name]["Visible"] = false;
			end
			Tabs_c["T"..v.Name].MouseButton1Click:Connect(function()
				for _,v in pairs(Tabs_b) do
					v.Visible = false;
				end
				Tabs_b["T"..v.Name].Visible = true;
			end)
		end
	end
	function Library:AddButton(Setting)
		Tabs_b["T"..Setting.Parent]["CanvasSize"] = UDim2.new(0, 0, Tabs_b["T"..Setting.Parent]["CanvasSize"].Y.Scale+0.1, Tabs_b["T"..Setting.Parent]["CanvasSize"].Y.Offset + 15);
		local NLK = {}
		NLK["NewButton"] = Instance.new("TextButton", Tabs_b["T"..Setting.Parent]);
	...
	function Library:AddTitle(Setting)
		Tabs_b["T"..Setting.Parent]["CanvasSize"] = UDim2.new(0, 0, Tabs_b["T"..Setting.Parent]["CanvasSize"].Y.Scale+0.1, Tabs_b["T"..Setting.Parent]["CanvasSize"].Y.Offset + 15);
		local NLK = {}
		NLK["NewTitle"] = Instance.new("Frame", Tabs_b["T"..Setting.Parent]);
	...
	function Library:AddToggle(Setting)
		Tabs_b["T"..Setting.Parent]["CanvasSize"] = UDim2.new(0, 0, Tabs_b["T"..Setting.Parent]["CanvasSize"].Y.Scale+0.1, Tabs_b["T"..Setting.Parent]["CanvasSize"].Y.Offset + 15);
		local NLK = {}
		NLK["NewToggle"] = Instance.new("Frame", Tabs_b["T"..Setting.Parent]);
	...
	function Library:AddInput(Setting)
		Tabs_b["T"..Setting.Parent]["CanvasSize"] = UDim2.new(0, 0, Tabs_b["T"..Setting.Parent]["CanvasSize"].Y.Scale+0.1, Tabs_b["T"..Setting.Parent]["CanvasSize"].Y.Offset + 15);
		local NLK = {}
		NLK["NewInput"] = Instance.new("Frame", Tabs_b["T"..Setting.Parent]);
	...
	function Library:AddPageName(Setting)
		Tabs_b["T"..Setting.Parent]["CanvasSize"] = UDim2.new(0, 0, Tabs_b["T"..Setting.Parent]["CanvasSize"].Y.Scale+0.14, Tabs_b["T"..Setting.Parent]["CanvasSize"].Y.Offset + 15);
		local NLK = {}
		NLK["NewPageName"] = Instance.new("Frame", Tabs_b["T"..Setting.Parent]);
	...
	function Library:AddDropdown(Setting)
		Tabs_b["T"..Setting.Parent]["CanvasSize"] = UDim2.new(0, 0, Tabs_b["T"..Setting.Parent]["CanvasSize"].Y.Scale+0.1, Tabs_b["T"..Setting.Parent]["CanvasSize"].Y.Offset + 15);
		Tabs_dropdown[Setting.Slog] = Instance.new("TextButton", Tabs_b["T"..Setting.Parent]);
		...
		local ptll = {Value = Setting.Value}
	...
	function Library:AddSlider(Setting)
		Tabs_b["T"..Setting.Parent]["CanvasSize"] = UDim2.new(0, 0, Tabs_b["T"..Setting.Parent]["CanvasSize"].Y.Scale+0.1, Tabs_b["T"..Setting.Parent]["CanvasSize"].Y.Offset + 15);
		local NLK = {}
		NLK["NewSlider"] = Instance.new("Frame", Tabs_b["T"..Setting.Parent]);
